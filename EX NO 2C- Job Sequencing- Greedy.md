...
Check from its deadline slot backward (to schedule it as late as possible). If an empty slot (slot[j] == false) is found: Mark it as occupied (slot[j] = true).
...
7. Output: Return {jobsDone, totalProfit}. Print the number of jobs scheduled and total profit obtained.
...
<img width="368" height="421" alt="m12-t3op" src="https://github.com/user-attachments/assets/93b0dee3-ae99-4ee6-941b-629fa719dede" />
